...
import { useGetCivilCaseDocumentList } from '@query/query';
import { CaseUploadModal, DocumentListPanel } from '@/components/case-evidence';
...
const CaseMainListTable = ({ title, civilCaseId, onSelectCaseDocumentId }: TCaseMainListTableProps): JSX.Element => {
...
export default CaseMainListTable;
