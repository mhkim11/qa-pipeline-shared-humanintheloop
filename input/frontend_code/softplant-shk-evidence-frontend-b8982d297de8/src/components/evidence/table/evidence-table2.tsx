...
export const EvidenceTable = ({
  ...
  return (
    <S.AllBody>
      <div id='evidence-table-head' className='absolute right-[7.5%] top-[150px] z-20 flex items-center 2xl:right-[15%]'>
        <div className=''>
          <div className='flex'>
      ...
      <DragDropContext onDragEnd={handleDragEnd}>
        <div className='relative'>
          ...
          <div
            ...
            className={cn(
              `fixed left-[20px] top-[400px] z-[50] flex -translate-y-1/2 flex-col gap-3 rounded-[12px] bg-white p-[7px] shadow-lg sm:left-1 md:left-[20px] 2xl:left-[calc(15%-85px)]`,
                    ...
                    >
                      <thead className='evidence-table-header sticky top-0 z-50 bg-[#E6EFFF] font-bold text-[#252525]'>
                        ...
                        <tr className='h-[52px]'>
                          {/* 체크박스 컬럼 헤더 수정 */}
                          <th
                            className='cursor-col-resize whitespace-nowrap rounded-tl-[8px] pb-[26px] pt-[8px] text-center hover:after:absolute hover:after:right-0 hover:after:top-0 hover:after:z-10 hover:after:mr-[1.5px] hover:after:h-full hover:after:w-[6px] hover:after:bg-[#97C0F1] hover:after:content-[""]'
                          ...
                          <th
                            className='w-[5%] min-w-[50px] cursor-col-resize whitespace-nowrap pb-[26px] pt-[8px] text-center hover:after:absolute hover:after:right-0 hover:after:top-0 hover:after:z-10 hover:after:mr-[1.5px] hover:after:h-full hover:after:w-[6px] hover:after:bg-[#97C0F1] hover:after:content-[""]'
                          ...
                          <th
                            ...
                            className='w-[5%] min-w-[50px] cursor-col-resize whitespace-nowrap pb-[26px] pt-[8px] text-left hover:after:absolute hover:after:right-0 hover:after:top-0 hover:after:z-10 hover:after:mr-[1.5px] hover:after:h-full hover:after:w-[6px] hover:after:bg-[#97C0F1] hover:after:content-[""] 2xl:w-[15%]'
                          >
                          ...
                          <th
                            className='w-[4%] min-w-[40px] cursor-col-resize whitespace-nowrap pb-[26px] pt-[8px] text-left hover:after:absolute hover:after:right-0 hover:after:top-0 hover:after:z-10 hover:after:mr-[1.5px] hover:after:h-full hover:after:w-[6px] hover:after:bg-[#97C0F1] hover:after:content-[""]'
                          ...
                          <th
                            ...
                            className='w-[15%] min-w-[250px] cursor-col-resize whitespace-nowrap pb-[26px] pt-[8px] text-left hover:after:absolute hover:after:right-0 hover:after:top-0 hover:after:z-10 hover:after:mr-[1.5px] hover:after:h-full hover:after:w-[6px] hover:after:bg-[#97C0F1] hover:after:content-[""] 2xl:w-[15%]'
                          >
                          ...
                          <th
                            className='w-[13%] min-w-[130px] cursor-col-resize whitespace-nowrap pb-[26px] pt-[8px] text-left hover:after:absolute hover:after:right-0 hover:after:top-0 hover:after:z-10 hover:after:mr-[1.5px] hover:after:h-full hover:after:w-[6px] hover:after:bg-[#97C0F1] hover:after:content-[""]'
                          ...
                          <th
                            scope='col'
                            className='w-[8%] min-w-[70px] cursor-col-resize whitespace-nowrap pb-[26px] pl-4 pr-3 pt-[8px] text-left text-sm font-semibold text-gray-900 hover:after:absolute hover:after:right-0 hover:after:top-0 hover:after:z-10 hover:after:mr-[1.5px] hover:after:h-full hover:after:w-[6px] hover:after:bg-[#97C0F1] hover:after:content-[""]'
                          ...
                          <th
                            className='min-w-[100px] cursor-col-resize whitespace-nowrap pb-[26px] pt-[8px] text-left hover:after:absolute hover:after:right-0 hover:after:top-0 hover:after:z-10 hover:after:mr-[1.5px] hover:after:h-full hover:after:w-[6px] hover:after:bg-[#97C0F1] hover:after:content-[""] 2xl:w-[8%]'
                          ...
                          <th
                            className='w-[10%] min-w-[100px] cursor-col-resize whitespace-nowrap pb-[26px] pt-[8px] text-center hover:after:absolute hover:after:right-0 hover:after:top-0 hover:after:z-10 hover:after:mr-[1.5px] hover:after:h-full hover:after:w-[6px] hover:after:bg-[#97C0F1] hover:after:content-[""]'
                          ...
                          <th
                            className='relative w-[7%] min-w-[110px] cursor-col-resize whitespace-nowrap text-center hover:after:absolute hover:after:right-0 hover:after:top-0 hover:after:z-10 hover:after:mr-[1.5px] hover:after:h-full hover:after:w-[6px] hover:after:bg-[#97C0F1] hover:after:content-[""]'
                          ...
                          <th
                            className='w-[5%] min-w-[70px] cursor-col-resize whitespace-nowrap pb-[26px] pt-[8px] text-left hover:after:absolute hover:after:right-0 hover:after:top-0 hover:after:z-10 hover:after:mr-[1.5px] hover:after:h-full hover:after:w-[6px] hover:after:bg-[#97C0F1] hover:after:content-[""]'
                          ...
                          <th
                            className='w-[7%] min-w-[110px] cursor-col-resize whitespace-nowrap rounded-tr-[8px] pb-[26px] pt-[8px] text-left hover:after:absolute hover:after:right-0 hover:after:top-0 hover:after:z-10 hover:after:mr-[1.5px] hover:after:h-full hover:after:w-[6px] hover:after:bg-[#97C0F1] hover:after:content-[""]'
                      ...
                      <tbody {...provided.droppableProps} ref={provided.innerRef} className='overflow-y-auto'>
                        {isProcessing ? (
                          <tr className=''>
                            <td colSpan={12} className='h-[300px] text-center' style={{ minWidth: `${totalTableMinWidth}px` }}>
                              <CustomSpinner />
                            </td>
                          </tr>
                                ...
                                {(dragProvided, dragSnapshot) => (
                                  <>
                                    ...
                                    >
                                      ...
                                      <td
                                        className={`w-[4%] truncate py-3 text-center text-[#212121] ${getFontSizeClass(14, fontSizeAdjustment)}`}
                                        style={{
                                      ...
                                      >
                                        <div
                                          ...
                                          onClick={(e) => {
                                            e.stopPropagation();
                                            handleViewDocument(item.evidence_id);
                                          }}
                                          style={{
                                            fontSize: `${getAdjustedSize(14)}px`,
                                            display: '-webkit-box',
                          ...
                          // 검색 결과 없음
                          <tr>
                            <td colSpan={12} className='pb-6 pt-8 text-center text-gray-500'>
                              검색 결과가 없습니다.
                            </td>
                          </tr>
                        )}
