...
export const SCustomerContentWrapper = styled.div`
  ${tw`grid h-full min-h-[630px] w-full grid-cols-5 gap-4 divide-x divide-neutral-300`}
`;
...
export const CustomerWrapper = styled.div`
  ${tw`relative flex flex-col gap-y-2 py-4`}
`;

export const XWrapper = styled.div`
  ${tw`absolute right-2 top-6 cursor-pointer rounded-full p-1 ring-1 ring-neutral-300 transition-colors hover:bg-neutral-100`}
`;
